  ...
  return (
    <div className="flex justify-center">
      <div className="w-1/2 flex flex-col gap-2 p-8 sm:flex-row sm:items-center sm:gap-12 sm:py-4">
        <img className="mx-auto block h-42 rounded-full sm:mx-0 sm:shrink-0" src={photo} alt="Davide Betterini" />
        ...
        <div className="space-y-2 text-center sm:text-left">
          <div className="space-y-0.5">
            ...
            <p className="text-base font-medium">Ruby On Rails - JavaScript - ReactCSS <br/> Bootstrap - TailwindCSS - Git</p>
          </div>
        </div>
